...
var ex = angular.module('App', ['ionic', 'ngCordova', 'ngAnimate', 'ngSanitize'])
...
(function () {
	...
	function HomeController($scope, $ionicPopup, Modals, Model) {
		...
		$scope.HelloWorld = function () {
			$ionicPopup.alert({
				title: 'FAV QUOTE',
				template: 'YOUR MIND IS A POWERFUL THING. WHEN YOU FILL IT WITH POSITIVE THOUGHTS, YOUR LIFE WILL START TO CHANGE.',
